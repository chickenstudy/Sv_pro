...
async def list_events(
    ...
    if from_dt:    conditions.append(f"event_timestamp >= '${len(params)+1}'"); params.append(from_dt)
    if to_dt:      conditions.append(f"event_timestamp <= '${len(params)+1}'"); params.append(to_dt)
